...
func main() {
	...
	// create the director for uploaded files and image files
	...
	app.Start(fmt.Sprintf(":%d", *portInt), dirForStatic, version, receiveDir, imageRelativeDir, viewPath, educatorNames)
